...
public:
	...
	std::string GetChartReplaySessionCode(void) { return m_ChartReplaySessionCode; };
	std::string GetChartReplaySeriesCode(void) { return m_ChartReplaySeriesCode; };
...
private:
	...
	std::string m_ChartReplaySessionCode;
	std::string m_ChartReplaySeriesCode;
