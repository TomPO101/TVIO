...
TradingView::Session::Session(TradingView::TVIO* TVIO, std::string timeFrame, std::string timeGroup, SessionChartID sessionChartID) :
	m_TVIO(TVIO),
	m_Outbox(new TradingView::Outbox(m_TVIO)),
	m_Inbox(new TradingView::Inbox(m_TVIO)),
	m_SessionChartID(sessionChartID),
...
void TradingView::Session::CreateSession(void)
{
	...
	startSession.AddParameter<std::string>(m_SessionChartID.chartSessionID);
	...
	switchTimeZone.AddParameter<std::string>(m_SessionChartID.chartSessionID);
	...
	resolveSymbol.AddParameter<std::string>(m_SessionChartID.chartSessionID);
	...
	createSeries.AddParameter<std::string>(m_SessionChartID.chartSessionID);
...
void TradingView::Session::RequestMoreData(unsigned int type, unsigned int amount)
{
	...
	requestData.AddParameter<std::string>(m_SessionChartID.chartSessionID);
...
void TradingView::Session::ExtendDataWithReplay(void)
{
	...
	replaySession.AddParameter<std::string>(m_SessionChartID.chartReplaySessionID);
	...
	replayAddSeries.AddParameter<std::string>(m_SessionChartID.chartReplaySessionID);
	replayAddSeries.AddParameter<std::string>(m_SessionChartID.chartReplaySeriesID);
	...
	nlohmann::json paramJs;
	paramJs[REPLAY] = m_SessionChartID.chartReplaySessionID;
	...
	modifySeries.AddParameter<std::string>(m_SessionChartID.chartSessionID);
	...
	replayReset.AddParameter<std::string>(m_SessionChartID.chartReplaySessionID);
	replayReset.AddParameter<std::string>(m_SessionChartID.chartReplaySeriesID);
...
void TradingView::Session::SetAuth(void)
{
