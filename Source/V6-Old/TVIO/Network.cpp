...
Network::Network(Log& log, const int sessionID) :
    m_Log(log),
...
bool Network::ConnectWithProxy(void)
{
    beast::error_code ec;
...
bool Network::Write(const std::string& message)
{
    beast::error_code ec;
...
bool Network::Read(std::string& messageBuffer)
{
    beast::error_code ec;
