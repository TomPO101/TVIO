...
Inbox::Inbox(DataPointManager& dataPointManager, const bool recordMessages) :
    m_Log("Inbox"),
...
std::string Inbox::WaitForMessage(const MessageType type, const bool processDPs, const int& id)
{
